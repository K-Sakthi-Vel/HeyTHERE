...
export const usersSlice = createSlice({
  ...
  reducers: {
    ...
    // adding likes
    addLikesToMessage:(state,action)=>{

      state.groupChat.filter((item,i)=>{

        if(item.name===action.payload.name && item.message === action.payload.message){
